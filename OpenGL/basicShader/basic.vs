...
// note : lorsqu'il n'y a qu'un seul 'attribute' on sait qu'il aura le 'location' 0

// le GPU rempli automatiquement les valeurs manquantes d'un attribute par 0.0 pour x, y , z et 1.0 pour w
...
void main(void)
{
	...
	vec2 newPosition = projectionMatrix * worldMatrix * a_Position.xy;
	...
	//gl_Position = vec4(a_Position, 0.0, 1.0) + vec4(sin(u_Time), 0.0, 0.0, sin(u_Time));
